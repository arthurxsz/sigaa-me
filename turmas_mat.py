...
unidade_select.select_by_visible_text("DEPARTAMENTO DE MATEMÁTICA - BRASÍLIA")

turmas_quero = {'MAT0053 - CALCULO NUMERICO',
                '01', '04', '05',
                }
turma_atual = []
...
while (True):
    ...
    for linha in linhas:
        ...
        if turma_atual and turma_atual[0] in turmas_quero and dados_linha[0] in turmas_quero:
            print(dados_linha)
